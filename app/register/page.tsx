    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 py-12">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        ...
        <div className="relative">
          <button
            disabled={true}
            className="w-full bg-gray-100 border border-gray-300 text-gray-400 py-2 px-4 rounded-lg font-semibold cursor-not-allowed flex items-center justify-center gap-2"
          >
          ...
          <div className="mt-2 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-sm text-yellow-800">
              <strong>Note:</strong> Google authentication is temporarily disabled while we configure OAuth domains. Please use email/password registration.
            </p>
          </div>
        </div>
